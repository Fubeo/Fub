...
tengono in piedi è in [../docs/architecture/frontend-and-ipc.md](../docs/architecture/frontend-and-ipc.md).
Il protocollo con cui il backend descrive un'interfaccia e questa cartella la
disegna è in [../docs/architecture/frontend-and-ipc.md](../docs/architecture/frontend-and-ipc.md).
...
con la [decisione 0015](../docs/decisions/0190-sessioni-documento-e-undo.md) e mai
scollegati di qui.
