...
if s.count(old_intro) != 1:
    raise SystemExit('intro rejoin legacy non trovato')
...
if s.count(old_test) != 1:
    raise SystemExit('test N↔N legacy non trovato')
...
'''
if s.count(old_repair) != 1:
    raise SystemExit('test repair dubbio legacy non trovato')
