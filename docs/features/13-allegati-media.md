...
- [ ] SVG sanitizzato
- [ ] Embed sicuri
- [ ] Pulsante/slider volume visibile nei player audio e video
- [ ] Riproduzione in loop (toggle) per audio e video
- [ ] Picture-in-picture per i video
...
- [ ] Pausa e ripresa della registrazione con scorciatoia
