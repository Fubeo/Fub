...
- [ ] Nota veloce il cui titolo deriva dalla prima riga
- [ ] Cattura del testo selezionato
- [ ] Nota scratch/appunti temporanea
- [ ] Apri subito la nota appena catturata
...
- [ ] Aggiungi la clip a una nota esistente
- [ ] Modifica del titolo della clip prima del salvataggio
...
- [ ] Anteprima dell'email prima dell'import
- [ ] Scelta della cartella di destinazione all'import email
- [ ] Conversione degli allegati email in allegati del vault
