...
- [`crates/fub-app/src/main.rs`](../../crates/fub-app/src/main.rs): l'eseguibile principale, punto di avvio del programma.
- [`crates/fub-app/src/lib.rs`](../../crates/fub-app/src/lib.rs): registrazione di tutti i comandi `#[tauri::command]` esposti alla shell.
- [`crates/fub-app/tauri.conf.json`](../../crates/fub-app/tauri.conf.json): configurazione di Tauri (titolo finestra, permessi di sicurezza, percorso dei file compilati del frontend).

---

## Se vuoi il dettaglio

- Guarda [`docs/07-ui/03-comandi-eventi-ipc.md`](../07-ui/03-comandi-eventi-ipc.md) per l'elenco completo dei messaggi scambiati tra frontend e backend.
