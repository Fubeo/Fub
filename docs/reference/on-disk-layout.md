...
consenso `granted`; al riavvio rilegge queste scelte. Gestione desktop,
lifecycle delle modifiche allo store e IPC restano da completare in
[#8](https://github.com/Fubeo/Fub/issues/8). La decisione persistente è nell'
