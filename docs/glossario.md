...
### spazio dati
`DataRead` / `DataWrite` · [`abi/traits.rs:650`](../crates/fub-abi/src/traits.rs) · [0013](decisions/0013-elenco-delle-capacita.md)
...
### capacità
`HostApi` · [`abi/traits.rs:1181`](../crates/fub-abi/src/traits.rs) · [0013](decisions/0013-elenco-delle-capacita.md), [0021](decisions/0021-il-confine.md)
...
### manifest
`PluginManifest` · [`abi/traits.rs:3293`](../crates/fub-abi/src/traits.rs) · [0013](decisions/0013-elenco-delle-capacita.md)
...
### provider
`FormatProvider`, `ViewProvider`, … · [`abi/traits.rs:1565`](../crates/fub-abi/src/traits.rs) · —
...
### canale dati
`IndexQuery` / `IndexResult` · [`abi/traits.rs:2111`](../crates/fub-abi/src/traits.rs) · [0005](decisions/0005-canale-dati-verso-le-view.md), [0019](decisions/0019-il-canale-dati.md)
...
### canale metadata
`HostQuery::query_index` · [`abi/traits.rs:965`](../crates/fub-abi/src/traits.rs) · [0005](decisions/0005-canale-dati-verso-le-view.md)
...
### finestra
`Page` / `Paged<T>` · [`abi/traits.rs:1648`](../crates/fub-abi/src/traits.rs) · [0019](decisions/0019-il-canale-dati.md)
...
### indice
`IndexProvider` · [`abi/traits.rs:2967`](../crates/fub-abi/src/traits.rs) · [0019](decisions/0019-il-canale-dati.md)
...
### instradamento
`QueryRoute` · [`abi/traits.rs:2637`](../crates/fub-abi/src/traits.rs) · [0019](decisions/0019-il-canale-dati.md)
...
### risultato
`DocumentMatch` · [`abi/traits.rs:1962`](../crates/fub-abi/src/traits.rs) · [0019](decisions/0019-il-canale-dati.md)
...
### esemplare
`ViewInstance` · [`abi/traits.rs:1307`](../crates/fub-abi/src/traits.rs) · [0037](decisions/0037-lo-stato-di-vista.md)
...
### stato di vista
`ViewStateRead` · [`abi/traits.rs:752`](../crates/fub-abi/src/traits.rs) · [0037](decisions/0037-lo-stato-di-vista.md)
...
### superficie di vista
`ViewSurface` · [`abi/traits.rs:1261`](../crates/fub-abi/src/traits.rs) · [0016](decisions/0016-cosa-e-una-view.md)
...
### view
`ViewProvider` / `ViewSpec` · [`abi/traits.rs:1359`](../crates/fub-abi/src/traits.rs) · [0016](decisions/0016-cosa-e-una-view.md)
