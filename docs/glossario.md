...
### proprietà
`PropertyValue` · [`abi/model.rs:1077`](../crates/fub-abi/src/model.rs) · [0003](decisions/0003-modello-del-documento.md)
...
### ricongiungimento
`rejoin_renamed_while_closed` · [`kernel/workspace.rs:6165`](../crates/fub-kernel/src/workspace.rs) · [0099](decisions/0099-una-rinomina-che-non-ha-visto-nessuno.md)
