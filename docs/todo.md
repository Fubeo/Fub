...
([0069](decisions/0069-cosa-sa-dire-un-abbonamento.md)). Centoventinove sono
chiuse e i loro verbali stanno in [decisions/](decisions/README.md); le altre
quattro [conta: voci-aperte] sono qui, e questo file è il loro **indice**.
...
| **17** | [I presidi che restano](roadmap/17-presidi-che-restano.md) | senza precedenze e senza scadenza: il criterio è se il costo cresce con l'attesa | 1 | 1 |
...
Quattro [conta: voci-aperte]. Il numero è quello con cui le nomina il resto del repo.
...
La colonna *Voci* somma **quattro** [conta: voci-aperte], e le **sedute 20 e 23
...
- [I verbali delle decisioni chiuse](decisions/README.md) — **centododici** [conta: verbali],
