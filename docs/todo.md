...
([0069](decisions/0069-cosa-sa-dire-un-abbonamento.md)). Centouno sono
...
| **21** | [La ricerca predefinita, e cosa le manca per esserlo](roadmap/21-la-ricerca-predefinita.md) | la ricerca è built-in e di classe *omnisearch*: qui sta la distanza fra quella frase e il repo | 3 | — |
...
- [I verbali delle decisioni chiuse](decisions/README.md) — **ottantatré** [conta: verbali],
