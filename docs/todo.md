...
| **§15.7** | [L'apertura del vault è tutto-o-niente, sincrona e senza ritorno](roadmap/15-il-disco.md#157-lapertura-del-vault-è-tutto-o-niente-sincrona-e-senza-ritorno) *(il tutto-o-niente non c'è più: [0068](decisions/0068-un-vault-si-apre-per-quel-che-si-legge.md); resta la forma)* | 15. Il disco: storage, durabilità, politiche | kernel | **P1** |
