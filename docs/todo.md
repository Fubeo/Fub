...
([0069](decisions/0069-cosa-sa-dire-un-abbonamento.md)). Centododici sono
chiuse e i loro verbali stanno in [decisions/](decisions/README.md); le altre
venti [conta: voci-aperte] sono qui, e questo file è il loro **indice**.
...
| **23** | [Cosa le decisioni chiuse costano a chi usa Fub](roadmap/23-cosa-costano-le-decisioni-chiuse.md) | prezzi dichiarati da un verbale, ognuno in una riga, che nessun elenco ha poi sommato | 12 | 1 |

## Le voci

Venti [conta: voci-aperte]. Il numero è quello con cui le nomina il resto del repo.
...
venti [conta: voci-aperte] come deve. Il residuo di una voce **chiusa** non
...
La colonna *Voci* somma **venti** [conta: voci-aperte], e la seduta 23 ne
tiene dodici da sola. Non è uno squilibrio da correggere: è ciò che succede
...
- [I verbali delle decisioni chiuse](decisions/README.md) — **novantacinque** [conta: verbali],
