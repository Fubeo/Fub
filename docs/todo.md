...
| **17** | [I presidi che restano](roadmap/17-presidi-che-restano.md) | senza precedenze e senza scadenza — e il criterio della seduta ha tagliato in due la §17.1: il corpus e il fuzzing sono chiusi dalla [0060](decisions/0060-il-modello-dice-il-vero-sui-byte.md) (il costo cresceva con l'attesa), resta il **banco delle prestazioni**, che aspetta una macchina e non una decisione | 3 | — |
...
- [I verbali delle decisioni chiuse](decisions/README.md) — **sessanta**, uno per
  file (`ls docs/decisions/0*.md | wc -l`; diceva «cinquantasette», ed erano
