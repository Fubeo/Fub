...
([0069](decisions/0069-cosa-sa-dire-un-abbonamento.md)). Centoquindici sono
...
| **23** | [Cosa le decisioni chiuse costano a chi usa Fub](roadmap/23-cosa-costano-le-decisioni-chiuse.md) | prezzi dichiarati da un verbale, ognuno in una riga, che nessun elenco ha poi sommato | 10 | 2 |
...
La colonna *Voci* somma **diciotto** [conta: voci-aperte], e la seduta 23 ne
tiene dieci da sola. Non è uno squilibrio da correggere: è ciò che succede
...
- [I verbali delle decisioni chiuse](decisions/README.md) — **novantotto** [conta: verbali],
