...
([0069](decisions/0069-cosa-sa-dire-un-abbonamento.md)). Centoventi sono
chiuse e i loro verbali stanno in [decisions/](decisions/README.md); le altre
tredici [conta: voci-aperte] sono qui, e questo file è il loro **indice**.
...
| **23** | [Cosa le decisioni chiuse costano a chi usa Fub](roadmap/23-cosa-costano-le-decisioni-chiuse.md) | prezzi dichiarati da un verbale, ognuno in una riga, che nessun elenco ha poi sommato | 5 | 2 |

## Le voci

Tredici [conta: voci-aperte]. Il numero è quello con cui le nomina il resto del repo.
...
tredici [conta: voci-aperte] come deve. Il residuo di una voce **chiusa** non
...
La colonna *Voci* somma **tredici** [conta: voci-aperte], e la seduta 23 ne
tiene cinque da sola. Non è uno squilibrio da correggere: è ciò che succede
...
- [I verbali delle decisioni chiuse](decisions/README.md) — **centotré** [conta: verbali],
