...
**Fatto insieme alla [decisione 0012](../decisions/0012-origine-degli-eventi.md), con quattro decisioni e un residuo dichiarato.**
...
bulk fix e migrazioni, e questa voce lo diceva — ma che **non è promettibile senza
il journal del §15.2**: un annullamento che non sopravvive alla morte del processo
...
`EditReport::inverse()` della [decisione 0008](../decisions/0008-modifica-chirurgica.md) — e la decisione di chi lo conservi è il §13.3.
...
si vede su un test della [decisione 0008](../decisions/0008-modifica-chirurgica.md) che ora dice l'opposto di prima
...
corsa esisteva davvero, e la [decisione 0008](../decisions/0008-modifica-chirurgica.md) la rendeva visibile invece di far sparire una
...
comando); il **lotto che attraversa il giro sincrono** (§9.1: un import gira
