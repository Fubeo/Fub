...
l'`abi.wit` stesso resta **scartato**, e il motivo è misurabile: 1904 righe [conta: wit-commenti]
su 3706 [conta: wit-righe] sono prosa italiana del confine, che in Rust non c'è e ha un altro lettore.
