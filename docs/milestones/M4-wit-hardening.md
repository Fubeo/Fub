...
l'`abi.wit` stesso resta **scartato**, e il motivo è misurabile: 1763 righe [conta: wit-commenti]
su 3509 [conta: wit-righe] sono prosa italiana del confine, che in Rust non c'è e ha un altro lettore.
