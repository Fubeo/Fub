...
| tetto della raffica del ponte | [bridge.rs:64](../../crates/fub-host/src/bridge.rs) | **128** notice |
...
| chi decide se un pannello è invecchiato | [panel-host.ts:187](../../frontend/src/ui/panel-host.ts) via [rules/mirrored.ts](../../frontend/src/rules/mirrored.ts) | la gemella di `mask_wants` del kernel |
