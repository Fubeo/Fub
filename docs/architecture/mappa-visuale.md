...
| Thread del rilevatore | Quelli che decide `notify`, dietro la cargo feature `notify-watcher` — che è **accesa di default**. | [watcher.rs:311](../../crates/fub-host/src/watcher.rs) |
