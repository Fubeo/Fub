...
WASM di [M5](../milestones/M5-wasm-runtime.md) sia meccanico e non una rincorsa
...
- Mapping tipo-abi → costrutto WIT: [docs/architecture/traits.md](traits.md).
- Modello dati: [docs/architecture/data-model.md](data-model.md).
...
- Gli **alberi ricorsivi** (`block`, `inline`, `ui-node`) al confine sono
  ...
  [docs/architecture/traits.md](traits.md),
