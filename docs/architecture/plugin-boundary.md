...
| il pool **aspetta** chi ha già cominciato, e rifiuta chi è in coda | [runner.rs:551](../../crates/fub-host/src/runner.rs) | un job senza il suo `JobDone`, che per la shell resta in corso per sempre |
