...
| `JobRunner::start` | [runner.rs:996](../../crates/fub-host/src/runner.rs) | ultimo: prima che ci siano job, ci dev'essere un vault |
...
| il pool **aspetta** chi ha già cominciato, e rifiuta chi è in coda | [runner.rs:790](../../crates/fub-host/src/runner.rs) | un job senza il suo `JobDone`, che per la shell resta in corso per sempre |
