...
proposito — sta in
[06-contratto/03-il-contratto-wit.md](06-contratto/03-il-contratto-wit.md), e non si ripete
...
[`schemas_on_disk.rs`](../crates/fub-app/tests/schemas_on_disk.rs), che legge
...
| impostazioni | [`crates/fub-kernel/src/settings.rs:89`](../crates/fub-kernel/src/settings.rs) | 1 | i valori scritti, per vault e per macchina |
...
| sidecar del cestino | [`crates/fub-kernel/src/vault.rs:113`](../crates/fub-kernel/src/vault.rs) | 1 | da quale cartella veniva una voce cestinata |
