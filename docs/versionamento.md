...
| **versione del contratto** | [`ABI_VERSION`](../crates/fub-abi/src/traits.rs) (`traits.rs:3811`) e `package fub:abi@0.1.0` in [`crates/fub-abi/wit/fub/abi.wit`](../crates/fub-abi/wit/fub/abi.wit) | a un plugin **già compilato**, che non si ricompila | il confine si rompe a valle, dopo il rilascio, e a rompersi è il codice di qualcun altro |
...
[`abi_compatible`](../crates/fub-abi/src/traits.rs) (`traits.rs:4359`), e sta
in quattro righe:
...
| sidecar del cestino | [`crates/fub-kernel/src/vault.rs:122`](../crates/fub-kernel/src/vault.rs) | 1 | da quale cartella veniva una voce cestinata |
