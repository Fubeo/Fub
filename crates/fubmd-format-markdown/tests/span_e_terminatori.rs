...
//! in `fubmd-abi/src/model.rs`). Questo test lo verifica dove la promessa si può
...
//! decisione di FubMD, e un comportamento non dichiarato è una cosa che una `cargo
...
use fubmd_abi::model::{Block, DocumentModel, Inline, Span};
