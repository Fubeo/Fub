...
//! FubMD non ha modificato resta identico byte per byte; uno che ha modificato
...
//!
//! FubMD fa il secondo. Un file che non è UTF-8 non è un documento da convertire:
