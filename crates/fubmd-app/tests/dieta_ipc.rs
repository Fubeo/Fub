...
const CONTRATTO: &str = include_str!("../../fubmd-abi/src/traits.rs");
...
/// **I comandi Tauri di FubMD, tutti e soli, con la loro ragione.**
///
...
fn la_superficie_ipc_e_un_elenco_chiuso() {
    ...
    assert!(
        ...
        "la superficie IPC è cresciuta di: {}\
         ...
         \n(crates/fubmd-app/tests/dieta_ipc.rs) perché quel comando non poteva essere:\
         \n\
