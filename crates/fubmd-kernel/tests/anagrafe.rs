...
use fubmd_abi::event::{Event, Notice};
...
fn riaprire_un_vault_immutato_non_rilegge_niente() {
    ...
    for i in 0..5 {
        index.sources.insert(
            ...
            fubmd_abi::edit::Revision::of(&format!("contenuto {i}")).0,
        );
    }
...
fn un_allegato_che_compare_e_cambia_lo_annuncia_dicendo_cosa_e() {
    ...
    // Un PNG copiato nel vault a FubMD aperto. Prima di questa voce il ramo
