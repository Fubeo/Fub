...
//! [`Undo::steps`](fubmd_abi::command::Undo::steps) esiste per permettere.
//!
...
/// ([`AppliedEdit::replaced`](fubmd_abi::edit::AppliedEdit::replaced)), quindi
