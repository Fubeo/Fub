...
//!
//! Il prezzo è dichiarato, e sta nel doc di [`fubmd_abi::custom`]: una regola
...
use fubmd_abi::model::{Block, DocumentModel, Inline, ListItem, Span, TableRow};
...
mod tests {
    use super::*;
    use fubmd_abi::custom::SyntaxTrigger;
