...
//! contratto** ([`fubmd_abi::locale::civil_from_days`]) quando gli è nato un
//! secondo cliente dentro il confine: un argomento
//! [`Timestamp`](fubmd_abi::text::ArgValue::Timestamp) di un messaggio si
...
use fubmd_abi::locale::civil_from_days;
