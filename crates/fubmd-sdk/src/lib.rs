...
//!
//! `fubmd-kernel`, e nemmeno dietro una cargo feature. L'SDK è ciò che un guest
//! WASM importerà a M5, ed è **dipendenza normale** di
//! `fubmd-format-markdown`: il kernel qui dentro finirebbe nella libreria di un
...
//! eventi — sta in `fubmd-testkit`, che è un altro crate per questa ragione
//! ([decisione 0055](../../../docs/decisions/0055-il-banco-del-lato-host.md)).
//! È presidiato da `fubmd-abi/tests/dependency_invariant.rs`.
