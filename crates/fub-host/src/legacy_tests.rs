//! Private regression suites that must exercise lock ownership directly.
//!
//! These modules are unit tests rather than integration tests so the generic
//! custody primitive never becomes part of the release API.
