...
//! che la qualità della traduzione di Fub è la peggiore fra quelle dei plugin
...
//! `crates/fub-kernel/tests/le_stringhe.rs`.
//!
//! # Il degrado garbato
//!
...
impl<'a> Strings<'a> {
    ...
    /// stanno in `fub-host` e quelle del locale in `fub-kernel`, e sono due
