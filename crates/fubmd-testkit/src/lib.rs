//! # fubmd-testkit — il banco di prova del lato **host**
//!
...
//! suo gemello è [`fubmd_sdk::testing`], che è il lato *provider*: là si prova
...
//! `fubmd-format-markdown` e `fubmd-features` seminano un corpus con un
...
pub const SPIA: &str = "fubmd.testkit.spia";
...
impl Montato {
    ...
    /// programma — o Obsidian — mentre FubMD guarda altrove.
    ...
    /// # use fubmd_testkit::Banco;
    /// # use std::sync::Arc;
    /// # fn esempio(states: Arc<fubmd_kernel::ViewStates>) {
