...
export const api = {
  ...
  openGrid: (surface: string, source: string) =>
    invoke<GridSession>("open_grid", { surface, source }),
  ...
  reloadGrid: (surface: string, instance: string, source: string) =>
    invoke<GridSession>("reload_grid", { surface, instance, source }),
