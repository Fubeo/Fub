...
export const SHELL_KEYS = {
  ...
  "shell.explorer.rename": null,
  "shell.explorer.trash": null,
  ...
  "shell.tab.move.left": "Mod-Shift-PageUp",
  "shell.tab.move.right": "Mod-Shift-PageDown",
  "shell.tab.move.pane.previous": "Mod-Alt-PageUp",
  "shell.tab.move.pane.next": "Mod-Alt-PageDown",
  ...
  "shell.tab.reopen": "Mod-Shift-t",
  "shell.tab.next": "Mod-PageDown",
  "shell.tab.previous": "Mod-PageUp",
  "shell.zoom.in": "Mod-=",
  "shell.zoom.out": "Mod--",
  "shell.zoom.reset": "Mod-0",
  "shell.focus.toggle": null,
