...
"switcher.actions_hint": "Invio: apri qui · Ctrl/⌘+Invio: dividi · Ctrl/⌘+Maiusc+Invio: nuova finestra · Alt+Invio: anteprima",
...
"document.links_unavailable": "Collegamenti del documento non disponibili: {reason}",
...
"trash.os_fallback": "Il sistema non ha un cestino disponibile: {doc} è nel cestino del vault.",
...
"save.conflitto": "Cambiato su disco",
  ...
  "sync.paused_banner": "Sincronizzazione in pausa",
  "sync.running": "Sincronizzazione: {count} operazioni in corso",
  "sync.idle": "Nessuna sincronizzazione in corso",
  "sync.no_vault": "Apri un vault per sincronizzarlo.",
  "sync.vault_state": "Rilevamento modifiche: {watching}; errori: {failures}",
  "sync.pause": "Metti in pausa",
  "sync.resume": "Riprendi",
  "sync.push_now": "Invia le modifiche",
  "sync.pull_now": "Ricevi le modifiche",
  "sync.exclude_hint": "Le esclusioni si configurano nelle impostazioni di sincronizzazione.",
  "sync.paused_set": "Sincronizzazione messa in pausa.",
  "sync.resumed_set": "Sincronizzazione ripresa.",
  "sync.pause_failed": "Impossibile modificare la pausa: {reason}",
  "sync.command_ok": "Operazione richiesta: {command}",
  "sync.command_failed": "Operazione {command} non riuscita: {reason}",
...
"switcher.actions_hint": "Enter: open here · Ctrl/⌘+Enter: split · Ctrl/⌘+Shift+Enter: new window · Alt+Enter: preview",
...
"document.links_unavailable": "Document links unavailable: {reason}",
...
"trash.os_fallback": "The system trash is not available: {doc} is in the vault trash.",
...
"save.conflitto": "Changed on disk",
  ...
  "sync.title": "Sync",
  "sync.paused_banner": "Sync paused",
  "sync.running": "Sync: {count} operations running",
  "sync.idle": "No sync operation running",
  "sync.no_vault": "Open a vault to sync it.",
  "sync.vault_state": "Change detection: {watching}; errors: {failures}",
  "sync.pause": "Pause sync",
  "sync.resume": "Resume sync",
  "sync.push_now": "Push changes",
  "sync.pull_now": "Pull changes",
  "sync.exclude_hint": "Configure exclusions in the sync settings.",
  "sync.paused_set": "Sync paused.",
  "sync.resumed_set": "Sync resumed.",
  "sync.pause_failed": "Could not change the pause state: {reason}",
  "sync.command_ok": "Operation requested: {command}",
  "sync.command_failed": "Operation {command} failed: {reason}",
