...
export const HOOKS = [
  ...
  "focus", "pane-preview",
  "grid-surface", "grid-sheet-tabs", "grid-formula-bar", "grid-sheet-tab", "grid-address",
  "grid-row-header", "grid-column-header", "grid-corner", "grid-viewport", "grid-cell",
  "grid-cell-active", "grid-cell-editor", "grid-read-only",
...
export const COMPONENTS: readonly ShellComponent[] = [
  ...
  { name: "grid", parts: ["grid"], states: selectable, hooks: ["grid-surface", "grid-sheet-tabs", "grid-formula-bar", "grid-sheet-tab", "grid-address", "grid-row-header", "grid-column-header", "grid-corner", "grid-viewport", "grid-cell", "grid-cell-active", "grid-cell-editor", "grid-read-only"] },
