...
export const HOOKS = [
  ...
  "math-inline", "math-block", "katex-display", "inline-highlight", "embed", "embed-cycle", "embed-too-deep", "image-missing", "empty-note",
...
export const COMPONENTS: readonly ShellComponent[] = [
  ...
  { name: "markdown-preview", parts: ["preview"], states: [S("rest"), S("selected")], hooks: ["markdown-preview", "markdown-rendered", "markdown-code-copy", "wikilink", "unresolved", "tag", "callout", "callout-title", "task", "math-inline", "math-block", "katex-display", "inline-highlight", "embed", "embed-cycle", "embed-too-deep", "image-missing", "empty-note", "block-footnote-definition", "footnote-ref", "block-frontmatter-unparsed", "mermaid-diagram", "cm-markdown-block", "link-preview", "doc-preview"] },
  { name: "declarative-slot", parts: ["preview"], states: rest, hooks: ["ui-slot"] },
  { name: "context-menu", parts: ["context-menu"], states: interactive, hooks: ["context-menu", "menu-label", "menu-hint", "menu-separator"] },
