...
export const HOOKS = [
  ...
  "search-input", "search-results", "search-result", "hit-title", "hit-occurrence", "hit-create", "hit-snippet",
  "segmented", "segmented--titlebar", "segmented--wide", "segmented-option",
  "panes", "pane-split", "row", "col", "pane-tabs", "tab-entry", "tab", "tab-name", "dirty", "tab-close", "pane",
  "pane-toolbar",
  ...
  "math-inline", "math-block", "katex-display", "inline-highlight", "embed", "embed-cycle", "embed-too-deep", "empty-note",
  ...
  "titlebar", "win-ctrl", "win-ctrl--close", "rail", "inspector-tabs", "inspector-tab", "inspector-tab-label",
  "inspector-title",
...
export const COMPONENTS: readonly ShellComponent[] = [
  { name: "app-surface", parts: ["foundation"], states: rest, hooks: ["app", "onboarding", "onboarding-actions"] },
  ...
  { name: "inspector-tabs", parts: ["chrome"], states: selectable, hooks: ["inspector-tabs", "inspector-tab", "inspector-tab-label", "inspector-title"] },
  ...
  { name: "search", parts: ["search"], states: selectable, hooks: ["search-input", "search-results", "search-result", "hit-title", "hit-occurrence", "hit-create", "hit-snippet"] },
  ...
  { name: "pane-tree", parts: ["panes"], states: [S("rest"), S("focused")], hooks: ["panes", "pane-split", "row", "col", "pane", "focus", "pane-preview", "pane-toolbar"] },
  { name: "pane-tabs", parts: ["panes"], states: selectable, hooks: ["pane-tabs", "tab-entry", "tab", "tab-name", "dirty", "tab-close", "tab-view"] },
  ...
  { name: "markdown-preview", parts: ["preview"], states: [S("rest"), S("selected")], hooks: ["markdown-preview", "markdown-rendered", "markdown-code-copy", "wikilink", "unresolved", "tag", "callout", "callout-title", "task", "math-inline", "math-block", "katex-display", "inline-highlight", "embed", "embed-cycle", "embed-too-deep", "empty-note", "block-footnote-definition", "footnote-ref", "block-frontmatter-unparsed", "mermaid-diagram", "cm-markdown-block", "link-preview", "doc-preview"] },
