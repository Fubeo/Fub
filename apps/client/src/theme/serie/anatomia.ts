...
export const COMPONENTS: readonly ShellComponent[] = [
  ...
  { name: "markdown-preview", parts: ["preview"], states: [S("rest"), S("selected")], hooks: ["markdown-preview", "wikilink", "unresolved", "tag", "callout", "callout-title", "task", "math-block", "inline-highlight", "embed", "embed-cycle", "embed-too-deep", "empty-note", "block-footnote-definition", "footnote-ref", "block-frontmatter-unparsed", "mermaid-diagram"] },
