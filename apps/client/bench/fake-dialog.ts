...
//
// Sono tre, e nel banco fanno la cosa che un fotogramma può contenere: la
...
// la corsa per sempre —, il selettore di cartella risponde il vault del banco
// perché l'unica scena che lo apre è quella della finestra senza vault, e il
// selettore di file viene annullato senza aprire risorse del sistema operativo.
//
