...
//
// Nel banco fanno la cosa che un fotogramma può contenere: la conferma dice
// sempre di sì — un `confirm` nativo aprirebbe una finestra del window manager,
// che non sta dentro lo screenshot della pagina e bloccherebbe la corsa per
// sempre —, il selettore di cartella risponde il vault del banco, mentre i
// selettori di file e destinazione supporto vengono annullati senza aprire
