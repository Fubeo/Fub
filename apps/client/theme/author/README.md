...
Il contratto richiede **116 ruoli**, espone **258 hook**, **7 stati** (129 assegnazioni su 42 componenti). Hook non assegnati: **0**. Gli elenchi e le coppie di contrasto sono in `contract.json`, generato dalle sorgenti della shell.
