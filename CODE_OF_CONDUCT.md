...
Il testo che segue non è scritto qui: è la **traduzione italiana ufficiale del
Contributor Covenant 2.1**, ripresa senza modifiche salvo l'indirizzo a cui si
segnala. È una scelta, e la ragione è l'opposto di quella che regge il resto di
[`docs/`](README.md): un codice di condotta riscritto a mano è un testo che
nessuno riconosce, e chi arriva deve poter leggere la prima riga e sapere già
cosa dice il resto, invece di verificarlo frase per frase. Qui l'originalità è
un difetto.

Due cose che il testo standard non dice, e che valgono per questo repo:

- **Le «guide della comunità» sono una persona sola**, il manutentore. Le
  segnalazioni arrivano a lui e non c'è nessun altro a cui rivolgersi: se il
  problema è lui, il canale che resta è pubblico, ed è GitHub.
- **Il perimetro** sono le issue, le pull request e le discussioni di questo
  repo. Le vulnerabilità non stanno qui: hanno un canale privato, ed è
...
I casi di comportamento abusivo, molesto o altrimenti inaccettabile possono essere presentati contattando i responsabili dell'applicazione di questo Codice di Condotta della comunità all'indirizzo **fabio99marchetti@gmail.com**. Tutti i reclami saranno prontamente esaminati ed indagati.
...
Per risposte a domande comuni riguardo questo codice di condotta, controlla le domande frequenti al link [https://www.contributor-covenant.org/faq][FAQ]. Le traduzioni sono disponibili al link [https://www.contributor-covenant.org/translations][translations].
